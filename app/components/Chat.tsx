          ...
          <div className="space-y-4">
            <div>
              <p className="text-emerald-800">
                I have implemented a chatbot using the GPT4o mini model via a Python backend. A system prompt guides the AI's responses, which could be given much more depth by implementing retrieval-augmented generation (RAG). The barrier to doing this is that I don't have enough data about myself and my book collection. A future version of this app may feature a better-informed bot.
              </p>
            </div>
          </div>
        </div>
