    ...
    {/* Hero Section */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-purple-50 rounded-xl p-8 shadow-sm">
            ...
            I am comfortable implementing designs, but I do not consider myself to be a designer. The overall look of this site was AI-assisted, with most of the visual design generated by Claude.AI — although I have drawn inspiration from other sources as well. I am currently refactoring the AI-generated HTML and CSS into more readable and reusable React components.
            </p>
          </div>
        </div>
      </div>
