        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-purple-50 rounded-xl p-8 shadow-sm">
            ...
            <p className="text-purple-800">
              I am capable of implementing designs, but I would never pretend to be a designer myself. Most of the general look for this site (but none of the functionality) was AI-generated, although I have picked up ideas from elsewhere too. I am in the process of refactoring the HTML/CSS code generated by Claude.AI to turn it into more readable and reusable React components.
            </p>
          </div>
        </div>
      </div>
